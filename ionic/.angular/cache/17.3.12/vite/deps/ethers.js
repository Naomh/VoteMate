...
var AbstractProvider = class {
  ...
  broadcastTransaction(signedTx) {
    return __async(this, null, function* () {
      const { blockNumber, hash: hash3, network } = yield resolveProperties({
  ...
  getTransactionReceipt(hash3) {
    return __async(this, null, function* () {
      ...
      if (params.gasPrice == null && params.effectiveGasPrice == null) {
        const tx = yield this.#perform({ method: "getTransaction", hash: hash3 });
        if (tx == null) {
  ...
  waitForTransaction(hash3, _confirms, timeout) {
    return __async(this, null, function* () {
      ...
      return new Promise((resolve, reject) => __async(this, null, function* () {
        ...
        const listener = (blockNumber) => __async(this, null, function* () {
          try {
            const receipt = yield this.getTransactionReceipt(hash3);
            if (receipt != null) {
...
var JsonRpcSigner = class extends AbstractSigner {
  ...
  sendTransaction(tx) {
    return __async(this, null, function* () {
      const blockNumber = yield this.provider.getBlockNumber();
      const hash3 = yield this.sendUncheckedTransaction(tx);
      return yield new Promise((resolve, reject) => {
        const timeouts = [1e3, 100];
        let invalids = 0;
        const checkTx = () => __async(this, null, function* () {
          try {
            const tx2 = yield this.provider.getTransaction(hash3);
            if (tx2 != null) {
