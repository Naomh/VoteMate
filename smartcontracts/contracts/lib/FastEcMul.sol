...
library FastEcMul {
  ...
  ) private pure
  {
    ...
    // P1 Lookup Table
    iPj = _iP[0];
    iPj[0] = [_points[0], _points[1], _points[2]]; // P1

    (double[0], double[1], double[2]) = EC.jacDouble(
      iPj[0][0],
      iPj[0][1],
      1,
      _aa,
      _pp);
    (iPj[1][0], iPj[1][1], iPj[1][2]) = EC.jacAdd(
      double[0],
      double[1],
      double[2],
      iPj[0][0],
      ...
      iPj[0][2],
      _pp);
    (iPj[2][0], iPj[2][1], iPj[2][2]) = EC.jacAdd(
      double[0],
      double[1],
      double[2],
      iPj[1][0],
      ...
      iPj[1][2],
      _pp);
    (iPj[3][0], iPj[3][1], iPj[3][2]) = EC.jacAdd(
      double[0],
      double[1],
      double[2],
      iPj[2][0],
    ...
    // P2 Lookup Table
    _iP[1][0] = [mulmod(_beta, _points[0], _pp), _points[1], _points[2]];	// P2
    ...
    // Q1 Lookup Table
    iPj = _iP[2];
    iPj[0] = [_points[3], _points[4], _points[5]];	// Q1
    (double[0], double[1], double[2]) = EC.jacDouble(
      iPj[0][0],
      iPj[0][1],
      1,
    ...
    // Q2 Lookup Table
    _iP[3][0] = [mulmod(_beta, _points[3], _pp), _points[4], _points[5]];	// P2
  ...
  private pure  returns (uint256, uint256, uint256)
  {
    ...
    while (i > 0) {
      ...
      (mulPoint[0], mulPoint[1], mulPoint[2]) = EC.jacDouble(
        mulPoint[0],
        mulPoint[1],
        mulPoint[2],
        _aa,
      ...
      if (ki > 8) {
        (mulPoint[0], mulPoint[1], mulPoint[2]) = EC.jacAdd(
          mulPoint[0],
          mulPoint[1],
          mulPoint[2],
          iP[0][(15 - ki) / 2][0],
